...
@if(session('mensaje'))
<div class="row">
<h1 class="center-align teal-text text-darken-3">{{ session('mensaje') }}</h1>
</div>
@endif
...
<div class="row">
<button class="btn waves-effect waves-light teal darken-2" type="submit" name="action">GUARDAR
</button>
</div>
